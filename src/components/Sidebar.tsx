import { LayoutDashboard, Package, Warehouse, ShoppingBag, Truck, Settings, Building2 } from 'lucide-react';

type Page = 'dashboard' | 'orders' | 'inventory' | 'warehouses' | 'channels' | 'shipping' | 'settings';
...
export function Sidebar({ currentPage, onPageChange }: SidebarProps) {
  const menuItems = [
    ...
    { id: 'warehouses' as Page, label: 'المستودعات', icon: Building2 },
